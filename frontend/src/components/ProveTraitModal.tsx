    ...
    <div>
      <div className="rounded-xl border border-ink-700 bg-ink-950/40 p-4 mb-5">
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-lg bg-sol-purple-muted/25 border border-sol-purple/25 flex items-center justify-center text-lg text-sol-purple">
        ...
        <div className="space-y-2.5">
          <div className="flex items-start gap-2.5">
            <span className="text-sol-purple mt-0.5 shrink-0 text-xs">✓</span>
            <div>
              <div className="text-xs font-medium text-sol-purple">Shared (public)</div>
  ...
  return (
    <div className="text-center py-4">
      ...
      <div className="h-1.5 bg-ink-800 rounded-full overflow-hidden max-w-xs mx-auto">
        <div
          className="h-full bg-linear-to-r from-sol-purple to-glow rounded-full transition-all duration-700 ease-out"
    ...
    <div className="text-center py-2">
      ...
      <div className="rounded-xl bg-ink-950/40 border border-ink-700 p-3 mb-4 text-left">
        ...
        <button
          ...
          className="w-full px-3 py-2 rounded-xl text-xs font-medium text-mist border border-ink-600 bg-ink-950/30 hover:border-sol-purple/30 hover:text-white transition-colors"
        >
      ...
      {txHash && (
        <div className="rounded-xl bg-ink-950/40 border border-ink-700 p-3 mb-4 text-left">
          ...
          <a
            ...
            className="text-[11px] text-sol-purple underline decoration-sol-purple/40 underline-offset-2 hover:decoration-sol-purple font-mono truncate block"
          >
