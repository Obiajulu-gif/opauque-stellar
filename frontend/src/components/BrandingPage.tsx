    ...
    <div className="min-h-dvh bg-ink-950 bg-grid-fade bg-size-grid text-white px-5 sm:px-8 py-10">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest text-sol-purple">Branding</p>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="rounded-xl bg-sol-gradient px-5 py-2.5 text-sm font-semibold text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
            >
              {zipLoading ? "Building ZIP..." : "Download ZIP"}
            </button>
            <Link
              to="/"
              className="rounded-xl border border-ink-600 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:border-sol-purple/40 hover:text-sol-purple"
            >
              Back
            </Link>
          </div>
          ...
          {assets.map((asset) => (
            ...
            >
              ...
              <button
                ...
                className="mt-4 w-full rounded-lg border border-ink-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:border-sol-purple/40 hover:text-sol-purple"
              >
                Download
              </button>
            </article>
